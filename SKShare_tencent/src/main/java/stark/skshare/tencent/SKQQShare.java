...
public class SKQQShare extends SKTencentShare {
    ...
    public void shareImageToQQ(Activity activity, SKTencentContent content, final SKShare.ShareCallback callback) {
        mActivity = activity;
    ...
    public void shareAppToQQ(Activity activity, SKTencentContent content, final SKShare.ShareCallback callback) {
        mActivity = activity;
        this.callback = callback;
        Bundle bundle = new Bundle();
